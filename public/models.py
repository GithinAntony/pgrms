...
from site_admin.models import Departments
from department.models import Registration as Department_Registartion
...
class Complaints(models.Model):
    unique_id=models.AutoField(primary_key=True, null=False)
    complaints_subject=models.CharField(max_length=255, default='null', null=False)
    complaints_text=models.TextField(default='null', null=False)
    selected_department = models.ForeignKey(Departments, on_delete=models.CASCADE)
...
class Messages(models.Model):
    ...
    department_user_id=models.IntegerField(default=0)
